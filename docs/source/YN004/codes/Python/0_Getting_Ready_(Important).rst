...
:red:`You can also open "Robot_Ultimate_Starter_Kit_for_Raspberry_Pi_Pico/Python_Software", we have prepared it in advance.`
...
:red:`Robot_Ultimate_Starter_Kit_for_Raspberry_Pi_Pico/Python_Firmware`
...
Click "Run current script" to execute the program and "Hello World!", "Welcome Robot" will be printed in "Shell". 
...
1.	Move the program folder " **Robot_Ultimate_Starter_Kit_for_Raspberry_Pi_Pico/Python_Codes** " to disk(D) in advance with the path of " **D:/Micropython_Codes** ". Open "Thonny"。
