...
:red:`If you have any concerns, please contact us via:` support@robot.com

The following is the code:

.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/09.1_Soft_LED/09.1_Soft_LED.py
    :linenos: 
    :language: python
    :lines: 1-12
    :dedent:
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/10.2_Soft_Colorful_Light/10.2_Soft_Colorful_Light.py
    :linenos: 
    :language: python
    :dedent:
...
In this project, we use a potentiometer to control Robot 8 RGBLED Module.
...
| |Chapter01_10|                                           |
+-------------------------+---------------+----------------+
| Rotary potentiometer x1 | Robot 8 RGB| Jumper         |
|                         |               |                |
|                         | LED Module x1 |                |
|                         |               |                |
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/10.3_Soft_Rainbow_Light/10.3_Soft_Rainbow_Light.py
    :linenos: 
    :language: python
    :dedent:
