...
Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "11.1_Thermometer" and double click "11.1_Thermometer.py". 
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/11.1_Thermometer/11.1_Thermometer.py
    :linenos: 
    :language: python
    :dedent:
