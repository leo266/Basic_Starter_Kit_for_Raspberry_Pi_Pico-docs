...
Codes used in this tutorial are saved in "Robot_Ultimate_Starter_Kit_for_Raspberry_Pi_Pico/Python_Codes". You can move the codes to any location. For example, we save the codes in Disk(D) with the path of "D:/Micropython_Codes".
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/01.1_Blink/01.1_Blink.py
    :linenos: 
    :language: python
    :dedent:
