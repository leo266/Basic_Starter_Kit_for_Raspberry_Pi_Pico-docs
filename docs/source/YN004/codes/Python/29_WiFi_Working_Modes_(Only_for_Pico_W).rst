...
Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "12.1_Station_mode" and double click "12.1_Station_mode.py". 
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/12.1_Station_mode/12.1_Station_mode.py
    :linenos: 
    :language: python
    :lines: 1-22
    :dedent:
...
Component List & Circuit are the same as in Section 13.1.
...
Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "12.2_AP_mode". and double click "12.2_AP_mode.py". 
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/12.2_AP_mode/12.2_AP_mode.py
    :linenos: 
    :language: python
    :lines: 1-26
    :dedent:
...
Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "12.3_AP+STA_mode"and double click "12.3_AP+STA_mode.py". 
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/12.3_AP+STA_mode/12.3_AP+STA_mode.py
    :linenos: 
    :language: python
    :lines: 1-41
    :dedent: