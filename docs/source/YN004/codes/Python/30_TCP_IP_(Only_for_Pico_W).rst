...
Open the " **Robot_Ultimate_Starter_Kit_for_Raspberry_Pi_Pico\\C\\Sketches\\Sketch_14.1_WiFiClient\\sketchWiFi\\sketchWiFi.pde** ", and click "Run".
...
Move the program folder " **Robot_Ultimate_Starter_Kit_for_Raspberry_Pi_Pico/Python/Python_Codes** " to disk(D) in advance with the path of " **D:/Micropython_Codes** ".

Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "13.1_TCP_as_Client" and double click "13.1_TCP_as_Client.py". 
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/13.1_TCP_as_Client/13.1_TCP_as_Client.py
    :linenos: 
    :language: python
    :lines: 1-43
    :dedent:
...
Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "13.2_TCP_as_Server" and double click "13.2_TCP_as_Server.py". 
...
Open the "Robot_Ultimate_Starter_Kit_for_Raspberry_Pi_Pico/Codes/MicroPython_Codes/13.2_TCP_as_Server/
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/13.2_TCP_as_Server/13.2_TCP_as_Server.py
    :linenos: 
    :language: python
    :lines: 1-53
    :dedent:
