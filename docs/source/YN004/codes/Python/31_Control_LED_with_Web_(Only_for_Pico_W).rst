...
Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "14.1_Control_LED_through_Web", and double click "14.1_Control_LED_through_Web.py".
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/14.1_Control_LED_through_Web/14.1_Control_LED_through_Web.py
    :linenos: 
    :language: python
    :lines: 1-87
    :dedent:
