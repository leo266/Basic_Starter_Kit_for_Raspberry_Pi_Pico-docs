...
Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "15.1_BLE". Right click "ble_advertising.py" and select "Upload to /" to upload it to Pico W. Then, double click "ble.py" to open the file.
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/15.1_BLE/15.1_BLE.py
    :linenos: 
    :language: python
    :lines: 1-92
    :dedent:
...
.. list-table::
   ...
   * -  Hardware connection. 
        ...
        :red:`If you need any support, please contact us via:` support@robot.com
   * -  |Chapter33_29| 
...
Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "15.2_BLE_LED". :red:`Right click "ble_advertising.py" and select "Upload to /" to upload it to Pico W`. Then, double click "ble_led.py" to open the file.
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/15.2_BLE_LED/15.2_BLE_LED.py
    :linenos: 
    :language: python
    :lines: 1-87
    :dedent:
