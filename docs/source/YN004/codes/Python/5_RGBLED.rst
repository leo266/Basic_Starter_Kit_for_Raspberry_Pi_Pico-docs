...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/05.1_RandomColorLight/05.1_RandomColorLight.py
    :linenos: 
    :language: python
    :dedent:
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/05.2_GradientColorLight/05.2_GradientColorLight.py
    :linenos: 
    :language: python
    :dedent:
