...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/07.1_Serial_Print/07.1_Serial_Print.py
    :linenos: 
    :language: python
    :lines: 1-3
    :dedent:
...
.. literalinclude:: ../../../robot_Kit/Python/Python_Codes/07.2_Serial_Read_and_Write/07.2_Serial_Read_and_Write_Usart0_to_Usart1.py
    :linenos: 
    :language: python
    :lines: 1-14
    :dedent:
